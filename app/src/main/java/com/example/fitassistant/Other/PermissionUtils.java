...
public abstract class PermissionUtils {
    ...
    public static void requestPermission(MapsFragment fragment, int requestId,
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(fragment.getActivity(), permission)) {
            ...
            ActivityCompat.requestPermissions(fragment.getActivity(), new String[]{permission}, requestId);

        }
    }

    /**
     * Checks if the result contains a {@link } result for a
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(), "",
                        Toast.LENGTH_SHORT).show(); //R.string.permission_required_toast
                getActivity().finish();
            }
        }
    }
