...
public class SettingsFragment extends Fragment {
    ...
    private void loadPreferences() {
        ...
        this.phone.setText(preferences.getString("phone", "0"));
        this.weight.setText(preferences.getString("weight", "0"));
        this.height.setText(preferences.getString("height", "0"));
    }
